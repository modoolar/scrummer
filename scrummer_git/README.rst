...
This module integrates ``project_git`` and ``scrummer`` modules by
...
In order to see registered commits one needs to open a task in Scrummer
...
To contribute to this module, please visit https://modoolar.comom
